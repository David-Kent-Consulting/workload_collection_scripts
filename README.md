...
top_10_long_running_queries.sql           Reports the top 10 long running queries, and then prompts for an SQL ID and
                                          child number to get the full SQL query
wait_class_and_their_waiting_time.sql     Reports general system information
waiting_events_and_session_details.sql    Reports by SID, USERNAME, EVENT, MACHINE, STATE,
                                          SQL ID, Partial SQL statement, Minutes + Seconds
                                          astats of running SQL statements.
